''' Example code provided by Microsoft 
    Note this code does not seem to run with Python 3.10 
    I had to set up a python 3.8 environment to get it to run
    It was an error with MutableMapping as I remember  
'''
...
try:
    ...
    client = client.Client(HOST, 'g',
                           username=f"/dbs/{DATABASE_ID}/colls/{CONTAINER_ID}",
                           password=MASTER_KEY,
