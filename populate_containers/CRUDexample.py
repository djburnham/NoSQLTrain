...
# ----------------------------------------------------------------------------------------------------------
# CRUD stands for Create Read Update Delete, This example script has procedures in to let you 
# perform these basic CRUD operations against a CosmosDB collection using the SQL API in Python
# 
# Prerequistes -
#
